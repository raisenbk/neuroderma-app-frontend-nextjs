...
'use client'; // Jadikan Client Component untuk menggunakan hook
          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <div className="w-10 h-10 sm:w-12 sm:h-12 relative mb-1 sm:mb-0 mx-auto">
                <Image
                  src="/neurodermadarkmode.png" alt="Logo NeuroDerma" fill
                  sizes="(max-width: 639px) 40px, 48px" className="object-contain dark:block" priority
                />
                <Image
                  src="/neuroderma.png" alt="Logo NeuroDerma" fill
                  sizes="(max-width: 639px) 40px, 48px" className="object-contain dark:hidden" priority
                />
              </div>
              <span className="text-xl sm:text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-indigo-800 dark:from-sky-400 dark:to-cyan-300">
                NeuroDerma
              </span>
              ...
              <p 
                className="mt-6 text-lg sm:text-xl leading-8 text-slate-700 dark:text-slate-300 max-w-3xl mx-auto"
                dangerouslySetInnerHTML={{ __html: t('about_page_subtitle') }} 
              />
            </div>
